...
<body>
    <div class="header">
        ...
        <p>Periode: <?php echo e(\Carbon\Carbon::parse($startDate)->format('d/m/Y')); ?> s/d <?php echo e(\Carbon\Carbon::parse($endDate)->format('d/m/Y')); ?></p>
    </div>
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                ...
                <td class="amount">Rp <?php echo e(number_format($subscriptionRevenue, 0, ',', '.')); ?></td>
            </tr>
            <tr>
                <td>Total Transaksi Langganan</td>
                <td class="amount"><?php echo e(number_format($subscriptionTransactions)); ?></td>
            </tr>
            <tr>
                <td>Pelanggan Aktif</td>
                <td class="amount"><?php echo e(number_format($activeSubscribers)); ?></td>
            </tr>
            <tr>
                <td>ARPU</td>
                <td class="amount">Rp <?php echo e(number_format($arpu, 0, ',', '.')); ?></td>
            </tr>
        </tbody>
    </table>
