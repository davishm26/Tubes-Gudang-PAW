        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="GET" action="<?php echo e(route('suppliers.index')); ?>" class="mb-4">
                    <div class="flex">
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari pemasok atau kontak..." class="flex-1 px-4 py-2 border border-[#E5E7EB] rounded-l-lg focus:outline-none focus:ring-2 focus:ring-[#1F8F6A]">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-[#E9F6F1]/30 transition">
                                    ...
                                    <td class="py-4 px-6 whitespace-nowrap text-sm font-medium">
                                        <a href="<?php echo e(route('suppliers.edit', $supplier->id)); ?>" class="text-[#1F8F6A] hover:text-[#166B50] font-semibold mr-3">Edit</a>
