                                    ...
                                    <div class="flex items-start gap-4">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <div class="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-white border border-[#C8E6DF] text-[#0F4C37]">
                                                <span class="text-[#166B50]"><?php echo $reasonInfo['icon']; ?></span>
                                                <span class="font-semibold"><?php echo e($reasonInfo['label']); ?></span>
                                            </div>
                        ...
                        <div class="bg-[#E9F6F1] rounded-xl border border-[#C8E6DF] p-6 mb-8">
                            ...
                            <div class="space-y-3 text-sm">
                                <div class="flex justify-between">
                                    ...
                                    <span class="text-[#0F4C37] font-semibold"><?php echo e(ucfirst($company->subscription_status ?? 'N/A')); ?></span>
                                </div>
                                <?php if($company->subscription_price): ?>
                                    <div class="flex justify-between">
                                        <span class="text-[#166B50] font-medium">Harga Langganan:</span>
                                        <span class="text-[#0F4C37] font-semibold">Rp <?php echo e(number_format($company->subscription_price, 0, ',', '.')); ?></span>
                                    </div>
                                <?php endif; ?>
                                <?php if($company->subscription_end_date): ?>
                                    <div class="flex justify-between">
                                        <span class="text-[#166B50] font-medium">Tanggal Berakhir:</span>
                                        <span class="text-[#0F4C37] font-semibold"><?php echo e(\Carbon\Carbon::parse($company->subscription_end_date)->format('d M Y')); ?></span>
                                    </div>
                                <?php endif; ?>
