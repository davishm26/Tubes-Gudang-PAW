...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Aktivitas - StockMaster <?php $__env->endSlot(); ?>
    <?php
        // Check demo mode
                                    ...
                                    <tr class="hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-6 py-5 whitespace-nowrap">
                                            <div class="text-sm font-medium text-gray-900">
                                                <?php echo e($createdAt ? $createdAt->format('d/m/Y H:i') : '-'); ?>

                                            </div>
                                            <div class="text-xs text-gray-500 mt-1">
                                                <?php echo e($createdAt ? $createdAt->locale(config('app.locale'))->diffForHumans() : '-'); ?>

                                            </div>
                                        </td>
                                        <?php if(Auth::check() && Auth::user()->role === 'super_admin'): ?>
                                            <!-- PERUSAHAAN (super admin) -->
                                            <td class="px-6 py-5 whitespace-nowrap text-sm font-medium text-gray-900"><?php echo e($companyName); ?></td>
                                            <!-- ENTITAS (super admin) -->
                                            <td class="px-6 py-5">
                                                <div class="text-sm font-semibold text-gray-900"><?php echo e($entityTypeLabel); ?></div>
                                                <div class="text-xs text-gray-500 mt-1"><?php echo e($entityName ?? '[Unknown]'); ?></div>
                                            </td>
                                        <?php else: ?>
                                            <!-- PENGGUNA (admin) -->
                                        ...
                                        <td class="px-6 py-5 whitespace-nowrap text-center">
                                            ...
                                            ?>
                                            <span
                                                class="inline-flex items-center px-3 py-1 text-xs font-semibold rounded-full <?php echo e($actionStyles[$action] ?? 'bg-gray-100 text-gray-700 border border-gray-200'); ?>">
                                                <?php echo e(strtoupper($action)); ?>
                                        ...
                                        <td class="px-6 py-5 text-sm">
                                            <?php if($changes): ?>
                                                <button onclick='showChanges(<?php echo json_encode($changes, 15, 512) ?>)'
                                        ...
                                        <td class="px-6 py-5 whitespace-nowrap text-center text-sm font-medium">
                                            <?php if($logId): ?>
                                                <a href="<?php echo e(route('audit-logs.show', $logId)); ?>"
