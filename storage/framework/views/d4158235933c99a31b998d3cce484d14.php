                                    ...
                                    <tr class="hover:bg-slate-50">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex justify-end gap-2 text-sm">
                                                ...
                                                <form action="<?php echo e(route('super_admin.tenants.send-notification', $company)); ?>" method="POST" class="inline">
                                                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\X1 Yoga\SEMESTER 3\Tubes paw\Tubespaw\Tubes-Gudang-PAW\resources\views/super_admin/tenants/index.blade.php ENDPATH**/ ?>