    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 rounded shadow">
                <form method="POST" action="<?php echo e(route('super_admin.tenants.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="mb-4">
...
<?php endif; ?>
<?php /**PATH D:\Semester 3\PAW\TUBES\tubes-gudang\resources\views\super_admin\tenants\create.blade.php ENDPATH**/ ?>