    ...
    <div id="demoModal" class="hidden fixed inset-0 bg-black/50 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full transform transition-all">
            <div class="p-6">
                ...
                <div class="space-y-4">
                    <button onclick="startDemo('admin')" class="w-full bg-gradient-to-r from-emerald-600 to-emerald-700 text-white px-6 py-4 rounded-xl hover:from-emerald-700 hover:to-emerald-800 transition-all duration-300 transform hover:scale-105 shadow-lg">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-2">
                    ...
                    <span class="text-xl font-bold gradient-text">StockMaster</span>
                </div>
                <div class="flex items-center space-x-4">
                    <a href="#features" class="text-slate-600 hover:text-emerald-600 transition-colors duration-300">Fitur</a>
                    <a href="#pricing" class="text-slate-600 hover:text-emerald-600 transition-colors duration-300">Harga</a>
                    <a href="#contact" class="text-slate-600 hover:text-emerald-600 transition-colors duration-300">Kontak</a>
                    <a href="<?php echo e(route('login')); ?>" class="bg-emerald-600 text-white px-4 py-2 rounded-lg hover:bg-emerald-700 transition-all duration-300 transform hover:scale-105">
                        Masuk
                    </a>
                </div>
            </div>
        ...
        <div class="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
            <div class="bounce-in">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center slide-up" style="animation-delay: 0.6s;">
                    <a href="<?php echo e(route('subscription.subscribe')); ?>" class="bg-white text-emerald-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-emerald-50 transition-all duration-300 transform hover:scale-105 pulse-glow shadow-lg">
                        Langganan Sekarang
                    </a>
                    <button onclick="openDemoModal()" class="border-2 border-white text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-white hover:text-emerald-600 transition-all duration-300">
                        🚀 Coba Demo
                    </button>
                </div>
            </div>
    ...
    <section id="features" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap gap-8 justify-center">
                <div class="w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.25rem)] max-w-md bg-gradient-to-br from-emerald-50 to-emerald-100 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 h-full" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.25rem)] max-w-md bg-gradient-to-br from-emerald-50 to-emerald-100 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 h-full" data-aos="fade-up" data-aos-delay="200">
                    <div class="w-12 h-12 bg-emerald-500 rounded-lg flex items-center justify-center mb-4">
                        <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.25rem)] max-w-md bg-gradient-to-br from-emerald-50 to-emerald-100 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 h-full" data-aos="fade-up" data-aos-delay="300">
                    <div class="w-12 h-12 bg-emerald-500 rounded-lg flex items-center justify-center mb-4">
                        <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.25rem)] max-w-md bg-gradient-to-br from-emerald-50 to-emerald-100 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 h-full" data-aos="fade-up" data-aos-delay="400">
                    <div class="w-12 h-12 bg-emerald-500 rounded-lg flex items-center justify-center mb-4">
                        <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.25rem)] max-w-md bg-gradient-to-br from-emerald-50 to-emerald-100 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 h-full" data-aos="fade-up" data-aos-delay="500">
                    <div class="w-12 h-12 bg-emerald-500 rounded-lg flex items-center justify-center mb-4">
                        <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z"/>
                        </svg>
                ...
                <div class="w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1.25rem)] max-w-md bg-gradient-to-br from-emerald-50 to-emerald-100 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 h-full" data-aos="fade-up" data-aos-delay="600">
                    <div class="w-12 h-12 bg-emerald-500 rounded-lg flex items-center justify-center mb-4">
                        <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="max-w-md mx-auto">
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-all duration-300" data-aos="zoom-in">
                    <div class="bg-gradient-to-r from-emerald-600 to-emerald-700 p-8 text-white text-center">
                        <h3 class="text-2xl font-bold mb-2">Paket Premium</h3>
                        <div class="text-4xl font-bold mb-2">Rp 1.000.000</div>
                        <div class="text-emerald-100">per tahun</div>
                    </div>
                    <div class="p-8">
                        ...
                        <a href="<?php echo e(route('subscription.subscribe')); ?>" class="block w-full bg-gradient-to-r from-emerald-600 to-emerald-700 text-white text-center py-3 rounded-lg font-semibold hover:from-emerald-700 hover:to-emerald-800 transition-all duration-300 transform hover:scale-105">
                            Langganan Sekarang
                        </a>
                    </div>
                </div>
    ...
    <section class="py-20 bg-gray-900 text-white">
        <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8" data-aos="fade-up">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('subscription.subscribe')); ?>" class="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-emerald-700 hover:to-emerald-800 transition-all duration-300 transform hover:scale-105 shadow-lg pulse-glow">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-600">
                        <li><a href="#" class="hover:text-emerald-600 transition-colors">Fitur</a></li>
                        <li><a href="#" class="hover:text-emerald-600 transition-colors">Harga</a></li>
                        <li><a href="#" class="hover:text-emerald-600 transition-colors">Demo</a></li>
                    </ul>
                </div>
                <div>
                    <h3 class="font-semibold text-gray-900 mb-4">Support</h3>
                    <ul class="space-y-2 text-gray-600">
                        <li><a href="#" class="hover:text-emerald-600 transition-colors">Dokumentasi</a></li>
                        <li><a href="#" class="hover:text-emerald-600 transition-colors">FAQ</a></li>
                        <li><a href="#" class="hover:text-emerald-600 transition-colors">Kontak</a></li>
                    </ul>
                </div>
                <div>
                    <h3 class="font-semibold text-gray-900 mb-4">Perusahaan</h3>
                    <ul class="space-y-2 text-gray-600">
                        <li><a href="#" class="hover:text-emerald-600 transition-colors">Tentang Kami</a></li>
                        <li><a href="#" class="hover:text-emerald-600 transition-colors">Karir</a></li>
                        <li><a href="#" class="hover:text-emerald-600 transition-colors">Blog</a></li>
                    </ul>
                </div>
            </div>
            <div class="border-t border-slate-200 mt-8 pt-8 text-center text-slate-600">
...
<?php /**PATH C:\Users\X1 Yoga\SEMESTER 3\tubespawpalingbarubanget\Tubes-Gudang-PAW\resources\views/subscription/landing.blade.php ENDPATH**/ ?>