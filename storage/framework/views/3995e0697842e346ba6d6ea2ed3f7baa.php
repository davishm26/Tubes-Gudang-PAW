...
<body class="bg-gray-100">
    <div class="min-h-screen flex items-center justify-center">
        <div class="max-w-md mx-auto p-8 bg-white shadow-lg rounded-lg text-center">
            ...
            <?php if(!empty($subscription['renew_company_id'])): ?>
            ...
            <a href="<?php echo e(route('login')); ?>" class="bg-[#1F8F6A] text-white px-4 py-2 rounded hover:bg-[#166B50] focus:outline-none focus:ring-2 focus:ring-[#1F8F6A] focus:ring-offset-1">Login Sekarang</a>
        </div>
    </div>
</body>
</html>
...
<?php /**PATH D:\Semester 3\PAW\TUBES\tubes-gudang\resources\views/subscription/success.blade.php ENDPATH**/ ?>