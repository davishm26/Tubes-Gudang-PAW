            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        ...
                        <p class="text-sm text-white/80">Periode: <?php echo e(\Carbon\Carbon::parse($startDate)->format('d/m/Y')); ?> s/d <?php echo e(\Carbon\Carbon::parse($endDate)->format('d/m/Y')); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between sm:gap-4">
                    <form method="GET" action="<?php echo e(route('super_admin.financial-report')); ?>" id="filterForm" class="flex flex-1 flex-col gap-3 sm:flex-row sm:items-end sm:gap-4">
                        <div class="w-full sm:w-44 space-y-1">
                            ...
                            <input type="date" name="start_date" id="start_date" value="<?php echo e($startDate); ?>" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm text-slate-900 focus:border-[#1F8F6A] focus:ring-2 focus:ring-[#1F8F6A]/20" />
                        </div>
                        <div class="w-full sm:w-44 space-y-1">
                            <label for="end_date" class="block text-xs font-semibold text-slate-700">Tanggal Akhir</label>
                            <input type="date" name="end_date" id="end_date" value="<?php echo e($endDate); ?>" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm text-slate-900 focus:border-[#1F8F6A] focus:ring-2 focus:ring-[#1F8F6A]/20" />
                        </div>
            ...
            <div class="bg-white border border-slate-200 shadow-sm rounded-2xl p-6 space-y-6">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="rounded-xl border border-slate-200 bg-white px-4 py-5 shadow-sm">
                        ...
                        <p class="mt-2 text-2xl font-semibold text-slate-900">Rp <?php echo e(number_format($arpu, 0, ',', '.')); ?></p>
                    </div>
                </div>
