            ...
            <div class="max-w-md mx-auto">
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-all duration-300" data-aos="zoom-in">
                    <div class="bg-gradient-to-r from-blue-600 to-purple-600 p-8 text-white text-center">
                        ...
                        <div class="text-blue-100">per tahun</div>
                    </div>
                    <div class="p-8">
...
<?php /**PATH C:\Users\X1 Yoga\SEMESTER 3\Tubes paw\Tubespaw\Tubes-Gudang-PAW\resources\views/subscription/landing.blade.php ENDPATH**/ ?>