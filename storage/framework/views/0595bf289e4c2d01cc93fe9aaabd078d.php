...
<?php endif; ?>
        ...
        <div class="flex items-center justify-between mt-4">
            <?php if(Route::has('password.request')): ?>
                <a class="underline text-sm text-gray-600 hover:text-emerald-800 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500" href="<?php echo e(route('password.request')); ?>">
            ...
            <div class="flex items-center space-x-4">
                <a href="<?php echo e(route('subscription.subscribe')); ?>" class="underline text-sm text-gray-600 hover:text-emerald-800 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500">
...
<?php endif; ?>
<?php /**PATH C:\Users\X1 Yoga\SEMESTER 3\tubespawpalingbarubanget\Tubes-Gudang-PAW\resources\views/auth/login.blade.php ENDPATH**/ ?>