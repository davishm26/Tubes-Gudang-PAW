        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-slate-200 overflow-hidden" x-data="{ status: '<?php echo e(old('tenant_status', $company->subscription_status ?? 'active')); ?>' }">
                ...
                <div class="bg-gradient-to-r from-[#1F8F6A] to-[#166B50] px-8 py-6 border-b border-[#145237]">
                    ...
                    <p class="text-white/80 text-sm">Perbarui <?php echo e($company->name); ?> — kontrol akses dan informasi tenant</p>
                </div>
                        ...
                        <div class="space-y-6 p-4 rounded-lg bg-red-50 border border-red-200">
                            ...
                            <div class="space-y-3">
                                ...
                                >
                                    ...
                                    <option value="policy_violation" <?php echo e(old('suspend_reason_type', $company->suspend_reason_type ?? '') === 'policy_violation' ? 'selected' : ''); ?>>Pelanggaran Kebijakan</option>
                                    <option value="admin_action" <?php echo e(old('suspend_reason_type', $company->suspend_reason_type ?? '') === 'admin_action' ? 'selected' : ''); ?>>Tindakan Admin</option>
                                    <option value="other" <?php echo e(old('suspend_reason_type', $company->suspend_reason_type ?? '') === 'other' ? 'selected' : ''); ?>>Lainnya</option>
                                </select>
