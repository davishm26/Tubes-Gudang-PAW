...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight"><?php echo e(__('Tambah Pengguna')); ?></h2>
     <?php $__env->endSlot(); ?>
                ...
                <form method="POST" action="<?php echo e(route('users.store')); ?>">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div>
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name')); ?>" class="mt-1 block w-full border rounded px-3 py-2" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="mt-1 block w-full border rounded px-3 py-2" required>
