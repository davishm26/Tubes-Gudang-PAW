        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="GET" action="<?php echo e(route('products.index')); ?>" class="mb-4">
                    <div class="flex">
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari produk, SKU, kategori, atau pemasok..." class="flex-1 px-4 py-2 border border-emerald-200 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-emerald-500">
...
<?php endif; ?>
<?php /**PATH C:\Users\X1 Yoga\SEMESTER 3\tubespawpalingbarubanget\Tubes-Gudang-PAW\resources\views/products/index.blade.php ENDPATH**/ ?>