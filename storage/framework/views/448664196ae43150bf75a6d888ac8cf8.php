...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Edit Produk - StockMaster <?php $__env->endSlot(); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="bg-gradient-to-r from-[#1F8F6A] to-[#166B50] pt-20 pb-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="font-semibold text-2xl text-white leading-tight"><?php echo e(__('Edit Produk: ') . $product->name); ?></h2>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" name="stock" id="stock" value="<?php echo e($product->stock); ?>" readonly
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <?php if($previewUrl): ?>
                                    <div class="mt-2">
                                        ...
                                        <img src="<?php echo e($previewUrl); ?>" alt="Gambar Lama" class="w-20 h-20 object-cover rounded">
                                    </div>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="flex items-center justify-end mt-6 border-t pt-4">
                            <a href="<?php echo e(route('products.index')); ?>" class="text-sm text-gray-600 hover:text-gray-900 mr-4">
                                Batal
                            </a>
...
<?php /**PATH D:\Semester 3\PAW\TUBES\tubes-gudang\resources\views/products/edit.blade.php ENDPATH**/ ?>