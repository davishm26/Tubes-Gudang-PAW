...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> Edit Pengguna - StockMaster <?php $__env->endSlot(); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="bg-gradient-to-r from-[#14B8A6] to-[#0D9488] pt-20 pb-8">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <h2 class="font-semibold text-2xl text-white leading-tight"><?php echo e(__('Edit Pengguna')); ?></h2>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
                ...
                <form method="POST" action="<?php echo e(route('users.update', $user->id)); ?>">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div>
                            ...
                            <input type="text" name="name" value="<?php echo e(old('name', $user->name)); ?>" class="mt-1 block w-full border border-[#E5E7EB] rounded-xl px-4 py-2 focus:ring-2 focus:ring-[#1F8F6A] focus:border-[#1F8F6A]" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" class="mt-1 block w-full border border-[#E5E7EB] rounded-xl px-4 py-2 focus:ring-2 focus:ring-[#1F8F6A] focus:border-[#1F8F6A]" required>
                        ...
                        <div>
                            ...
                            <select name="role" class="mt-1 block w-full border border-[#E5E7EB] rounded-xl px-4 py-2 focus:ring-2 focus:ring-[#1F8F6A] focus:border-[#1F8F6A]">
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($r); ?>" <?php echo e(old('role', $user->role)===$r ? 'selected' : ''); ?>><?php echo e($r === 'staf' ? 'Staf' : ucfirst($r)); ?></option>
...
<?php /**PATH D:\Semester 3\PAW\TUBES\tubes-gudang\resources\views/users/edit.blade.php ENDPATH**/ ?>