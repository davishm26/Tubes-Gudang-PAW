...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Edit Pemasok: ') . $supplier->name); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text"
                                   name="contact"
                                   id="contact"
                                   value="<?php echo e(old('contact', $supplier->contact)); ?>"
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="<?php echo e(route('suppliers.index')); ?>" class="text-sm text-gray-600 hover:text-gray-900 mr-4">
                                Batal
                            </a>
...
<?php endif; ?>
<?php /**PATH D:\Semester 3\PAW\TUBES\tubes-gudang\resources\views\suppliers\edit.blade.php ENDPATH**/ ?>