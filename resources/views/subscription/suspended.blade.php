            ...
            <div class="bg-white rounded-2xl shadow-lg border border-slate-200 overflow-hidden">
                ...
                <div class="px-8 py-8">
                    ...
                    <div class="bg-indigo-50 rounded-xl border border-indigo-200 p-6 mb-8">
                        <h4 class="font-semibold text-indigo-900 mb-2">Butuh Bantuan?</h4>
                        <p class="text-sm text-indigo-800">Hubungi tim dukungan pelanggan kami melalui email atau portal dukungan untuk penyelesaian lebih lanjut.</p>
                    </div>
                ...
                <div class="bg-slate-50 border-t border-slate-200 px-8 py-6 flex justify-center">
                    <a href="{{ route('subscription.landing') }}" class="inline-flex items-center justify-center px-8 py-3 rounded-lg bg-indigo-600 text-white font-semibold shadow-md hover:bg-indigo-700 active:bg-indigo-800 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
