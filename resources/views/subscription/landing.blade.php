        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('login') }}" class="bg-[#1F8F6A] text-white px-4 py-2 rounded-lg hover:bg-[#166B50] transition-all duration-300 transform hover:scale-105">
                        Masuk
                    </a>
                </div>
            </div>
        ...
        <div class="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
            <div class="bounce-in">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center slide-up" style="animation-delay: 0.6s;">
                    <a href="{{ route('subscription.subscribe') }}" class="bg-white text-[#1F8F6A] px-8 py-4 rounded-full text-lg font-semibold hover:bg-[#E9F6F1] transition-all duration-300 transform hover:scale-105 pulse-glow shadow-lg">
                        Langganan Sekarang
                    </a>
            ...
            <div class="max-w-md mx-auto">
                <div class="bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-all duration-300" data-aos="zoom-in">
                    ...
                    <div class="p-8">
                        ...
                        <a href="{{ route('subscription.subscribe') }}" class="block w-full bg-gradient-to-r from-[#1F8F6A] to-[#166B50] text-white text-center py-3 rounded-lg font-semibold hover:from-[#166B50] hover:to-[#0F4C37] transition-all duration-300 transform hover:scale-105">
                            Langganan Sekarang
                        </a>
                    </div>
                </div>
    ...
    <section class="py-20 bg-gray-900 text-white">
        <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8" data-aos="fade-up">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="{{ route('subscription.subscribe') }}" class="bg-gradient-to-r from-[#1F8F6A] to-[#166B50] text-white px-8 py-4 rounded-full text-lg font-semibold hover:from-[#166B50] hover:to-[#0F4C37] transition-all duration-300 transform hover:scale-105 shadow-lg pulse-glow">
